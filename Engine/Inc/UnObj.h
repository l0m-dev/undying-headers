...
public:
	...
	INT				unk1;			// this is somewhere before NumVertices
...
enum EPolyFlags
{
	...
	PF_BorderFiltering  = 0x00001000,	// UNDYING: apply texture filtering; Game-specific poly-level render control (reuse BigWavy flag)
	...
	PF_AlphaBlend		= 0x02000000,	// UNDYING: There's no special flag for alpha blending (PF_Translucent | PF_Modulated)

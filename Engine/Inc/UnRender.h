...
class ENGINE_API URenderBase : public USubsystem
{
	...
	UBOOL Exec( const TCHAR* Cmd, FOutputDevice& Ar=*GLog )=0;
	...
	virtual void Draw3DCircle( FSceneNode* Frame, FPlane Color, DWORD LineFlags, FVector& Location, const FVector& )=0;
	virtual void Draw3DEllipse( FSceneNode* Frame, FPlane Color, DWORD LineFlags, FVector& Location, const FVector&, const FVector& )=0;
	virtual void DrawBox( FSceneNode* Frame, FPlane Color, DWORD LineFlags, const FBox&, const FCoords& ) = 0;
	...
	virtual void DrawCoords( FSceneNode* Frame, float, DWORD, FVector, FVector )=0;
};
